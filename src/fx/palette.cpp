...
const PaletteDataT Limeade_gp = {
        0x007f5f, 0x1a8b51, 0x339743, 0x4da235,
        0x66ae26, 0x80b918, 0x99c40a, 0xaecd00,
        0xbbd100, 0xc7d400, 0xd4d700, 0xd9dc00,
        0xe0e206, 0xebec1a, 0xf5f52c, 0xffff3f
};

const PaletteDataT NeonDreams_gp = {
        0x0015ff, 0x550ee0, 0xaa07c0, 0xff00a1,
        0xda556b, 0xb5a936, 0x90fe00, 0x8ca955,
        0x8855aa, 0x8400ff, 0x5855fc, 0x2caafa,
        0x00fff7, 0x55d0a5, 0xaaa252, 0xff7300
};

const PaletteDataT MagicPlum_gp = {
        0x2d0cff, 0x4e09ff, 0x7006ff, 0x9102ff,
        0xa700fd, 0x9c00f5, 0x9100ee, 0x8600e6,
        0x9120c4, 0xb35f88, 0xd59f4b, 0xf7de0f,
        0xccd833, 0x88ba77, 0x449dbb, 0x007fff
};

const PaletteDataT AquaBloom_gp = {
        0x1be7ff, 0x31e8de, 0x47e9bd, 0x5dea9c,
        0x76ec7c, 0x95f260, 0xb5f744, 0xd4fc28,
...
const PaletteDataT BlueFlame_gp = {
        0x0b3866, 0x14456c, 0x1d5272, 0x275f79,
        0x306b7f, 0x397885, 0x42858b, 0x4b9291,
        0x559f98, 0x5eac9e, 0x67b9a4, 0x70c6aa,
        0x79d2b0, 0x83dfb7, 0x8cecbd, 0x95f9c3
};
